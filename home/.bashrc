...
alias sshnas='ssh -L 15443:192.168.1.10:80 136.33.225.202 -p 48480 | echo "Go to localhost:15443 for panel"'
...
__conda_setup="$('/home/maeve/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/maeve/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/maeve/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/maeve/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
